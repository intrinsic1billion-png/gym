...
const reviews = [
  ...
  },
  {
    ...
    name: "Tyler G.",
    rating: 5,
    text: "been wearing it every session. still looks brand new",
    product: "Black / Cyan"
  },
  {
    id: 12,
    name: "Sophie L.",
    rating: 5,
    text: "finally found gear that understands what gymnasts need",
    product: "Grey / Cyan"
  }
];
    ...
    <div className="customers-page">
      <div className="customers-container">
        ...
        <div className="customers-header">
          <h1 className="customers-title">WHAT ATHLETES SAY</h1>
          <div className="customers-rating">
            ...
            <span className="customers-rating-text">4.9 from 127 reviews</span>
          </div>
          <p className="customers-subtitle">
            Real feedback from real athletes who train in RAZE gear.
          </p>
        </div>
        ...
        <div className="customers-reviews-grid">
          {reviews.map((review) => (
            <div key={review.id} className="customers-review-card">
